...
import useCashierKasir from "./useCashier";
import DetailBuyKasir from "./DetailBuyKasir/DetailBuy";
import AllProductKasir from "./dataProductKasir/dataProduct";

export default function CashierKasir() {
  const {
  ...
  return (
    <>
      ...
      <div className="w-full px-4 py-4 bg-white/20 rounded-xl shadow-xl overflow-auto h-[500px]">
