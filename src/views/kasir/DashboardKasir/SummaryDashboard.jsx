...
import useSummaryKasir from "./useSummary";

export default function SummaryDashboardKasir() {
  const {
    countProduk,
    dataProduk,
    countCategories,
  ...
  return (
    <div className="mx-2 mt-4">
      ...
      <div className="grid grid-cols-7 gap-4">
        <Card className="h-72 !bg-white rounded-lg px-4 col-span-7 border-none">
          {/* Judul */}
